            ...
            >
              <div className="glass-panel rounded-[2.5rem] p-6 sm:p-8 md:p-12 relative overflow-hidden">
                ...
                <div className="mb-8 relative z-10 text-center lg:text-left">
                  <h2 className="text-2xl sm:text-3xl font-heading font-extrabold text-on-surface tracking-tight mb-2">
                    {authMode === 'login' ? 'Welcome back' : 'Create an account'}
                  </h2>
                  <p className="text-on-surface-variant text-sm">
                    {authMode === 'login' ? 'Enter your details to access your workspace.' : 'Sign up to start organizing your thoughts.'}
                  </p>
                </div>
                ...
                {/* Form */}
                <form onSubmit={handleEmailAuth} className="space-y-4 relative z-10 mb-6">
                  {authMode === 'register' && (
                    <input
                      type="text"
                      ...
                      autoComplete="name"
                      className="w-full px-5 py-4 rounded-2xl bg-surface/50 border border-outline-variant/30 text-on-surface focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all placeholder:text-on-surface-variant/50"
                    />
                  )}
                  <input
                    type="email"
                  ...
                  <motion.button
                    ...
                    type="submit"
                    disabled={isLoading}
                    className="w-full py-4 rounded-2xl bg-gradient-to-r from-primary to-secondary text-white font-bold text-base shadow-lg shadow-primary/20 transition-all disabled:opacity-50 min-h-[44px]"
                  >
                ...
                <div className="text-center relative z-10 mb-6">
                  <button 
                    onClick={() => { setAuthMode(authMode === 'login' ? 'register' : 'login'); setErrorCode(''); }}
                    className="text-sm font-medium text-on-surface-variant hover:text-primary transition-colors min-h-[44px] flex justify-center items-center w-full"
                  >
                ...
                <div className="relative mb-6 z-10">
                  <div className="absolute inset-0 flex items-center"><div className="w-full border-t border-on-surface/10" /></div>
                  <div className="relative flex justify-center"><span className="px-4 text-xs text-on-surface-variant font-semibold uppercase tracking-widest bg-surface-container-low">Or continue with</span></div>
                </div>
