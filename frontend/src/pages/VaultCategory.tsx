...
export default function VaultCategory() {
  ...
  return (
    <div className="max-w-7xl mx-auto w-full flex flex-col relative z-10 bg-white dark:bg-neutral-900 py-4 sm:p-5 md:p-6 pb-32 min-h-full">
      <AnimatePresence>
        {noGoogleDrive && (
          <motion.div
      ...
      <div className="flex flex-col mb-8 mt-2 px-4 sm:px-0">
        {isSelectionMode ? (
