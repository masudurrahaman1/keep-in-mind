...
export default function DocumentListCard({ 
  ...
  return (
    <motion.div
      ...
      className={`group relative flex flex-row gap-2 sm:gap-4 p-2 sm:p-4 bg-white dark:bg-[#1C1C1E] rounded-2xl sm:rounded-3xl shadow-sm border cursor-pointer hover:shadow-md transition-all duration-200 w-full mb-2 sm:mb-4 select-none
